...
class TimerTestScreen extends StatelessWidget {
  final TimerTestController questionController = Get.put(TimerTestController());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          Obx(() {
            return (questionController.isCompleted.value)
                ? const HGap(width: 0)
                : Row(
              children: [
                Container(
          ...
          return Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Obx(() {
                  return Text(
                    'Time left: ${questionController.timeLeft.value}s',
                    style: GoogleFonts.poppins(
                      fontSize: 18,
                      fontWeight: FontWeight.w500,
                      color: Colors.white,
