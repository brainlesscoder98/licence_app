...
class RtoCodesBulkUploadItem extends StatefulWidget {
  final String title;
  final List<String> allowedExtensions;

  const RtoCodesBulkUploadItem({
    Key? key,
    required this.title,
  ...
  @override
  State<RtoCodesBulkUploadItem> createState() =>
      _RtoCodesBulkUploadItemState();
}

class _RtoCodesBulkUploadItemState extends State<RtoCodesBulkUploadItem> {
  final controller = RtoCodesUploadController();
  @override
