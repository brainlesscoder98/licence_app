...
import 'package:license_master/controller/bulk_upload_controller/roadsign_upload_controller.dart';
import '../../controller/bulk_upload_controller/bulk_upload_controller.dart';
import '../../custom_widgets/c_elevated_button.dart';

class RoadSignBulkUploadItem extends StatefulWidget {
  final String title;
  final List<String> allowedExtensions;

  const RoadSignBulkUploadItem({
    Key? key,
    required this.title,
  ...
  @override
  State<RoadSignBulkUploadItem> createState() =>
      _RoadSignBulkUploadItemState();
}

class _RoadSignBulkUploadItemState extends State<RoadSignBulkUploadItem> {
  final controller = RoadSignUploadController();
  @override
