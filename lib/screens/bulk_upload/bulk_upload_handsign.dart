...
import 'package:license_master/controller/bulk_upload_controller/handsign_upload_controller.dart';
...
class HandSignBulkUploadItem extends StatefulWidget {
  final String title;
  final List<String> allowedExtensions;

  const HandSignBulkUploadItem({
    Key? key,
    required this.title,
  ...
  @override
  State<HandSignBulkUploadItem> createState() =>
      _HandSignBulkUploadItemState();
}

class _HandSignBulkUploadItemState extends State<HandSignBulkUploadItem> {
  final controller = HandSignUploadController();
  @override
